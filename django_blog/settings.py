...
STATIC_ROOT = '/opt/blogstatic'

# STATIC_ROOT = os.path.join(BASE_DIR, "static") # 部署时用

# STATICFILES_DIRS = [
#   os.path.join(BASE_DIR, "static"),
#   '/var/django_blog/static/',
# ]
...
SITE_CONFIGS = {
    ...
    # 站点底部footer配置
    'Footer': {
        'Email': '748797924@qq.com',  # 邮箱
        'Weibo': 'https://weibo.com/u/5399195058',  # 新浪微博
        'Music': 'https://music.163.com/#/user/home?id=1292165381',  # 音乐地址
        'Twitter': 'https://www.cnblogs.com/attila/',  # Twitter
        'GitHub': 'https://github.com/AttilaZang/BeneficialFriend.git',  # GitHub
        'Beian': '京ICP备19030110号',  # 备案号
    },

    # 侧边栏音乐插件配置
    'Music': {
        'enable': 'true',  # 是否启用：true/false
        'home': 'https://music.163.com/#/user/home?id=1292165381',  # 用户主页，点击会跳转到你的主页
        'server': 'netease',  # netease（网易云音乐）tencent（QQ音乐） xiami（虾米） kugou（酷狗）
        'mode': 'circulation',  # random （随机） single （单曲） circulation （列表循环） order （列表）
        'type': 'playlist',  # song （单曲） album （专辑） playlist （歌单） search （搜索）
        'id': '2847622375',  # 播放歌单id，获取方法自行百度。比如我的id就是链接后面的id,https://music.163.com/#/my/m/music/playlist?id=2847622375
        'autoplay': 'false',  # 是否自动播放：true/false
    },

    # 第三方评论Gitalk插件配置，关于下面的参数获取自己百度：(参考链接:https://www.jianshu.com/p/78c64d07124d)
    'Gitalk': {
        'clientID': '3879dcdb2ed4de02f4df',  # Github Application clientID
        'clientSecret': 'cefb677a09b266b59261b08e0d36a00a896fafb8',  # Github Application clientSecret
        'repo': 'comments',  # 存储你评论 issue 的 Github 仓库名
        'owner': 'AttilaZang',  # Github 用户名
        'admin': 'AttilaZang'
    },
